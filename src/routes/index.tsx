    ...
    <main className="relative overflow-hidden bg-[var(--bg-base)]">
      ...
      >
        ...
        <div className="relative z-10 max-w-5xl mx-auto text-center">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 opacity-0 animate-fade-in-up" style={{ animationDelay: '0.8s', animationFillMode: 'forwards' }}>
            <Link
              to="/analyze"
              className="group inline-flex items-center gap-3 px-8 py-4 bg-[var(--text-main)] text-[var(--bg-base)] text-xs tracking-[0.2em] uppercase font-medium hover:opacity-80 transition-opacity duration-200"
            >
      ...
      <section className="relative py-32 md:py-48 px-6 md:px-12">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <Link
            to="/analyze"
            className="group inline-flex items-center gap-4 px-10 py-5 bg-[var(--text-main)] text-[var(--bg-base)] text-xs tracking-[0.2em] uppercase font-medium hover:opacity-80 transition-opacity duration-200"
          >
